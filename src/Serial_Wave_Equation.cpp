#ifndef Serial_Wave_Equation_CPP
#define Serial_Wave_Equation_CPP

#include "Serial_Wave_Equation.h"
...
namespace Serial
{
	...
	void grid_to_file_serial(int out)
	{
	...
	int Serial_Wave_Equation(int argc, char *argv[])
	{
		// resize the 2-dimension vector
